...
# Init
tap = pd.read_csv('acc2005_2016-v2018.2.5.csv').merge(pd.read_csv('veh2005_2016-v2018.2.5.csv'), on='Accident_Index').drop(['Accident_Index', 'Date_Time', 'Year', 'Month', 'Day_of_Week', 'Hour'], axis=1)
...
joblib.dump(tap.columns.drop('Accident_Severity'), 'lda-rfe-tap_col.pkl')
