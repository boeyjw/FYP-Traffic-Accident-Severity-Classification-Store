...
y_score = classifier.fit(X_train[rfecv["after_sel_cols"]], Y_train).predict_proba(X_test[rfecv["after_sel_cols"]])
...
plt.title('Random Forest ROC Curve for No Casualty Features')
